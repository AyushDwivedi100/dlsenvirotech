...
if(isset($_POST['name']) || isset($_POST['email'])){
    ...
    $serviceType = $_POST['serviceType'] ?? 'General Inquiry';
    ...
    try {
        ...
        $mail->setFrom('info@powertonengineering.com', 'DLS Envirotech Contact Form');
        ...
        <tr>
            <td colspan='2' style='padding: 10px; border: 1px solid #ccc; background: #0066cc; color: white; text-align: center;'>
                <strong>This e-mail was sent from the contact form on DLS Envirotech Corporation website.</strong><br>
