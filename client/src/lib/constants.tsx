...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  {
    ...
    description:
      "Establishment and commissioning of comprehensive solid waste management infrastructure including Material Recovery Facility, Waste to Compost Plant, and Sanitary Landfill for municipal waste processing.",
    image: "",
    category: ["swm", "mrf"],
    tags: [
    ...
    technology:
      "Mechanical Segregation, Composting Technology, Engineered Landfill",
  ...
  },
  {
    ...
    description:
      "Comprehensive operation and maintenance management of solid waste management systems across multiple municipalities, ensuring efficient waste collection, processing, and disposal.",
    image: "",
    category: ["swm"],
    tags: [
  ...
  },
  {
    ...
    description:
      "Installation of advanced waste processing equipment including garbage separator trommel machine, shredding machine with conveyor belt, sorting conveyor machine, weight bridge, and sieving machine for efficient solid waste management.",
    image: "",
    category: ["swm"],
    tags: [
      "Trommel Machine",
  ...
  },
  {
    ...
    description:
      "Establishment of large-scale bio-methanation plant utilizing anaerobic digestion technology for waste-to-energy conversion, combined with waste to compost facility for sustainable waste management and renewable energy generation.",
    image: "",
  ...
  },
  {
    ...
    description:
      "Development of engineered sanitary landfill with integrated weight bridge system for scientific waste disposal and accurate waste quantification.",
    image: "",
    category: ["swm"],
    tags: ["Sanitary Landfill", "Weight Bridge", "Waste Disposal"],
    capacity: "30 MT",
    technology:
      "Engineered Landfill, Leachate Management, Weight Bridge System",
  ...
  },
  {
    ...
    description:
      "Establishment of Material Recovery Facility and Waste to Compost Plant for segregation, processing, and conversion of municipal solid waste into valuable resources.",
    image: "",
    category: ["swm", "mrf"],
    tags: [
      "Material Recovery Facility",
  ...
  },
  {
    ...
    description:
      "Establishment of Material Recovery Facility and Waste to Compost Plant for efficient municipal solid waste management and resource recovery.",
    image: "",
    category: ["swm", "mrf"],
    tags: ["Material Recovery Facility", "Waste to Compost", "Municipal Waste"],
    technology:
      "Mechanical Segregation, Composting Technology, Recyclable Recovery",
  ...
  },
  {
    ...
    description:
      "Establishment and commissioning of Material Recovery Facility and Waste to Compost Plant for comprehensive municipal solid waste management and resource recovery.",
    image: "",
    category: ["swm", "mrf"],
    tags: [
      "Material Recovery Facility",
  ...
  },
  {
    ...
    description:
      "Establishment and commissioning of Material Recovery Facility and Waste to Compost Plant for municipal solid waste processing and compost production.",
    image: "",
    category: ["swm", "mrf"],
    tags: [
      "Material Recovery Facility",
    ...
    technology:
      "Mechanical Segregation, Composting Technology, Resource Recovery",
  ...
  },
  {
    ...
    description:
      "Establishment and commissioning of Material Recovery Facility and Waste to Compost Plant for efficient municipal waste management and organic composting.",
    image: "",
    category: ["swm", "mrf"],
    tags: [
      "Material Recovery Facility",
    ...
    technology:
      "Mechanical Segregation, Aerobic Composting, Recyclable Recovery",
  ...
  },
  {
    ...
    description:
      "Establishment and commissioning of Material Recovery Facility and Waste to Compost Plant for sustainable municipal solid waste management and resource recovery.",
    image: "",
    category: ["swm", "mrf"],
    tags: [
      "Material Recovery Facility",
    ...
    technology:
      "Mechanical Segregation, Composting Technology, Material Recovery",
  ...
  },
  {
    ...
    description:
      "Commissioning and establishment of Material Recovery Facility and Waste to Compost Plant for comprehensive municipal solid waste processing and management.",
    image: "",
    category: ["swm", "mrf"],
    tags: [
      "Material Recovery Facility",
  ...
  },
  {
    ...
    description:
      "Design, supply, construction, installation, testing, and commissioning of Faecal Sludge Treatment Plant with hybrid mechanized screw press technology. Includes 3-4 years of operation and maintenance services.",
    image: "",
    category: ["fstp"],
    tags: [
    ...
    capacity: "5 KLD",
    technology:
      "Hybrid Mechanized System, Screw Press Technology, Advanced Sludge Dewatering",
  ...
  },
  {
    ...
    description:
      "Operation and maintenance management of comprehensive solid waste management systems for multiple municipal areas, ensuring efficient waste collection, processing, and disposal.",
    image: "",
    category: ["swm"],
    tags: [
      "Operation & Maintenance",
  ...
  },
  {
    ...
    description:
      "Development of engineered sanitary landfill with comprehensive waste disposal infrastructure for scientific and environmentally safe waste management.",
    image: "",
    ...
    technology:
      "Engineered Landfill, Leachate Management, Environmental Controls",
    client: "Kajalgaon Municipal Board, Assam (Chirang BTC)",
